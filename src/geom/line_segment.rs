...
impl LineSegment {
    ...
    pub fn intersect_segment(&self, other: &LineSegment) -> Option<f64> {
...
mod tests {
    ...
    fn test_intersect_vertical() {
        ...
        assert_eq!(Some(0.5), l1.intersect_segment(&l2));
        assert_eq!(Some(1.5), l1.intersect_segment(&l2.translate(Vector::new(10., 0.))));
    ...
    fn test_intersect_horizontal() {
        ...
        assert_eq!(Some(0.8), l1.intersect_segment(&l2));
    }
    ...
    fn test_intersect_regular() {
        ...
        assert_eq!(Some(0.8), l1.intersect_segment(&l2));
        assert_eq!(Some(0.6), l1.intersect_segment(&l2.translate(Vector::new(-2.0, -1.0))));
        assert_eq!(Some(1.2), l1.intersect_segment(&l2.translate(Vector::new(4.0, 2.0))));
        assert_eq!(Some(-0.2), l1.intersect_segment(&l2.translate(Vector::new(-10.0, -5.0))));
